exports.getQuestions = async function (topic, difficulty,rounds) {
    // Validate the text
      ...
      contents: [
        {
          parts: [
            {
              text: `
              Your task is to act as a JSON generator for a developer-focused hangman game. You must only reply with a single, valid JSON array containing exactly ${rounds} objects. Do not include any introductory text, explanations, or markdown.
